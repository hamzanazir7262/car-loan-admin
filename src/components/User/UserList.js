            ...
            >
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ fontSize: 14, fontWeight: 'bold' }}>Name</TableCell>
                  <TableCell sx={{ fontSize: 14, fontWeight: 'bold' }}>Email</TableCell>
                  <TableCell sx={{ fontSize: 14, fontWeight: 'bold' }}>Mobile</TableCell>
                  <TableCell sx={{ fontSize: 14, fontWeight: 'bold' }}>Join Date</TableCell>
              ...
              <TableBody>
                {paginatedRows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell sx={{ fontSize: 12, fontWeight: 'bold' }}>{row.name}</TableCell>
                    <TableCell sx={{ fontSize: 12, fontWeight: 'bold' }}>{row.email}</TableCell>
                    <TableCell sx={{ fontSize: 12, fontWeight: 'bold' }}>{row.mobile}</TableCell>
                    <TableCell sx={{ fontSize: 12, fontWeight: 'bold' }}>{row.joinDate}</TableCell>
