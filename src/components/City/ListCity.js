...
const ListCity = () => {
  const [rows, setRows] = useState([
    { id: 1, title: 'car title', status: 'publish' },
    { id: 2, title: 'car title', status: 'publish' },
    { id: 3, title: 'car title', status: 'publish' },
              ...
              <TableBody>
                {paginatedRows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell sx={{fontSize:14,fontWeight:"bold"}}>{row.title}
                    </TableCell>
