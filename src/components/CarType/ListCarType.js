...
const ListCarType = () => {
  const [rows, setRows] = useState([
    { id: 1, title: 'Sedan', image: '/logocar.jpeg', status: 'Available' },
    { id: 2, title: 'SUV', image: '/logocar.jpeg', status: 'Unavailable' },
    { id: 3, title: 'Hatchback', image: '/logocar.jpeg', status: 'Available' },
