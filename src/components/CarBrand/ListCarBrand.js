...
const ListCarBrand = () => {
  const [rows, setRows] = useState([
    { id: 1, title: 'Toyota', image: '/logocar.jpeg', status: 'Available' },
    { id: 2, title: 'Ford', image: '/logocar.jpeg', status: 'Unavailable' },
    { id: 3, title: 'BMW', image: '/logocar.jpeg', status: 'Available' },
