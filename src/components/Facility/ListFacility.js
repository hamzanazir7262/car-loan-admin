...
const ListFacility = () => {
  const [rows, setRows] = useState([
    { id: 1, title: 'Swimming Pool', image: '/logocar.jpeg', status: 'Available' },
    { id: 2, title: 'Gym', image: '/logocar.jpeg', status: 'Unavailable' },
    { id: 3, title: 'Spa', image: '/logocar.jpeg', status: 'Available' },
            ...
            >
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ fontSize: 14, fontWeight: 'bold' }}>Facility Title</TableCell>
                  <TableCell sx={{ fontSize: 14, fontWeight: 'bold' }}>Facility Image</TableCell>
                  <TableCell sx={{ fontSize: 14, fontWeight: 'bold' }}>
                    <TableSortLabel
